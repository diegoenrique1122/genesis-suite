...
export default function RegisterAthlete() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      /**
       * ================================================
       * GENESIS SECURE ATHLETE SIGNUP
       * ================================================
       *
       * El navegador SOLO crea la identidad Auth.
       *
       ...
       *   is_onboarded = false
       *
       * React NO puede asignarse planes,
       * roles administrativos ni perfiles manualmente.
       */
      ...
      /**
       * Si Supabase tiene confirmación de email
       * desactivada, tendremos sesión inmediatamente.
       */
       ...
       * el trigger YA creó la identidad Genesis,
       * pero el usuario debe confirmar su correo
       * antes de obtener una sesión.
       */

      alert(
        '✅ Cuenta creada. Revisa tu correo electrónico para confirmar tu cuenta antes de continuar.'
      );
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-[#111] border border-neutral-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <p className="text-xs text-neutral-500 font-mono mt-2 text-center">

            Crea tu cuenta para activar tu plan de 12 semanas.
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-black border border-neutral-800 rounded-xl pl-10 pr-4 py-3 text-sm text-white focus:border-amber-500 outline-none transition-colors"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-amber-500 text-black font-black uppercase tracking-widest text-xs py-4 rounded-xl hover:opacity-90 transition-opacity flex justify-center mt-6"
          >
